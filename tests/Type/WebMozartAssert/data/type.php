...
class TypeTest
{
	...
	public function isInstanceOfAny($a, $b, $c): void
	{
		Assert::isInstanceOfAny($a, [Bar::class, Baz::class]);
		\PHPStan\Testing\assertType('PHPStan\Type\WebMozartAssert\Bar|PHPStan\Type\WebMozartAssert\Baz', $a);

		Assert::isInstanceOfAny($b, [Baz::class]);
		\PHPStan\Testing\assertType('PHPStan\Type\WebMozartAssert\Bar|PHPStan\Type\WebMozartAssert\Baz', $a);
